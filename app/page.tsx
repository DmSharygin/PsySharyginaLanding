    ...
    <>
      <div className="prose max-w-3xl mx-auto p-6 text-gray-800 leading-relaxed">
        ...
        <p className="mb-4">
          ...
          1.1. Настоящая Политика в отношении обработки персональных данных (далее — Политика) определена в соответствии с Федеральным законом от 27.07.2006 № 152-ФЗ «О персональных данных» и действует в отношении всей информации, которую сайт <strong>https://psychologysharygina.ru/</strong> (далее — Сайт) может получить о Пользователе при заполнении веб-форм или использовании материалов и сервисов Сайта.
        </p>
        <p className="mb-4">
          1.2. Оператором персональных данных является: <strong>ИП Шарыгина Евгения Александровна</strong> (ИНН: 772402407266, [ОГРНИП / Статус плательщика НПД (самозанятый)]), e-mail: <strong>ginitolk@mail.ru</strong>.
        </p>
        <p className="mb-4">
          1.3. Отправка заявки через форму «Запись на консультацию», а также просмотр страниц и использование сервисов Сайта означает полное и безоговорочное согласие Пользователя с настоящей Политикой.
        </p>
        ...
        <p className="mb-4">
          2.2. При посещении Сайта автоматически обрабатываются технические данные (включая файлы cookie, IP-адрес, тип браузера, операционную систему, разрешение экрана и технические параметры устройства). Данные сведения обрабатываются в целях обеспечения технического функционирования Сайта и корректного отображения сторонних элементов (в частности, интерактивного виджета «Яндекс.Карты»).
        </p>
        ...
        <p className="mb-4">
          ...
          3.3. Обеспечение технической исправности, безопасности и корректного функционирования Сайта и его элементов (включая отображение карт и локаций).
        </p>

        <p className="mb-4">
          <strong>4. Использование сторонних сервисов и файлов Cookie</strong><br />
          4.1. Для отображения местоположения и интерактивных карт на Сайте используется виджет сервиса «Яндекс.Карты» (ООО «ЯНДЕКС», ИНН: 7736207543). При загрузке виджета Яндекс.Карт сервис может обрабатывать файлы cookie и технические данные Пользователя (IP-адрес, данные об устройстве) в соответствии с Политикой конфиденциальности ООО «ЯНДЕКС» (<a href="https://yandex.ru/legal/confidential/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">https://yandex.ru/legal/confidential/</a>).<br />
          4.2. Файлы cookie используются исключительно для корректной работы Сайта и встроенных сервисов. Сайт не использует сервисы веб-аналитики (такие как Яндекс.Метрика или Google Analytics) для отслеживания поведения Пользователя или сбора маркетинговых данных.<br />
          4.3. Пользователь может в любой момент отключить сохранение cookie или удалить их в настройках своего веб-браузера, однако это может привести к некорректной работе отдельных элементов Сайта (например, карты).
        </p>

        <p className="mb-4">
          <strong>5. Порядок и условия обработки персональных данных</strong><br />
          5.1. Обработка персональных данных осуществляется с соблюдением принципов законности, конфиденциальности и безопасности, предусмотренных ФЗ № 152-ФЗ.<br />
          5.2. Оператор принимает необходимые организационные и технические меры для защиты персональных данных Пользователя от неправомерного или случайного доступа.<br />
          5.3. Персональные данные Пользователя (включая темы обращений) являются строго конфиденциальными и не передаются третьим лицам, за исключением случаев, прямо предусмотренных законодательством РФ.<br />
          5.4. Хранение и первичная обработка персональных данных граждан РФ осуществляются на серверах, расположенных на территории Российской Федерации.
        </p>
...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <CookieBanner onOpenPrivacy={() => setActiveDoc('privacy')} />
    </div>
  );
}